...
<head>
  ...
  <style>
    /* Make all form inputs readonly in request_details.php */
    ...
    <div class="main">
      ...
      <div class="main-content">
        <div class="container-fluid p-4">
          ...
          <div id="viewForm">
            <div style="max-width: 1200px; width: 100%; margin: 0 auto; background: white; font-family: Arial, sans-serif; font-size: 13px;">
                ...
                <tr>
                  <td style="padding: 8px;">
                    ...
                    <div style="margin-bottom: 6px; font-size: 9px;">
                      <input type="checkbox" id="completed" name="status" value="completed" <?php echo $is_completed ? 'checked' : ''; ?> disabled />
            ...
            <!-- Small Acknowledgement Signature Pad (click box to draw) -->
                <div style="border-left: 1px solid black; border-right: 1px solid black; padding: 8px;">
                  ...
                  <div style="display: flex; align-items: center; gap: 12px;">
                    <div id="ack_sig_box" class="signature-box" data-saved="1" style="border:1px solid #000; width:180px; height:60px; display:flex; align-items:center; justify-content:center; cursor:default; pointer-events:none;">
