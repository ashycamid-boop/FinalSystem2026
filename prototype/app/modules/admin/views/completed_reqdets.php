...
<head>
  <meta charset="UTF-8">
  <title>Completed Request Details</title>
  <!-- Bootstrap 5 CSS -->
          ...
          <div style="max-width: 850px; margin: 0 auto; background: white; font-family: Arial, sans-serif; font-size: 11px;">
            ...
            <div style="padding: 10px; border-left: 1px solid black; border-right: 1px solid black;">
              ...
              <table style="width: 100%; margin-bottom: 10px;">
                <tr>
                  <td style="width: 50%;"><strong style="font-size: 10px;">Ticket No: <!-- dynamic ticket number here --></strong></td>
                  <td style="width: 50%; text-align: right;"><strong style="font-size: 10px;">Date (mm/dd/yyyy): <!-- dynamic date here --></strong></td>
                </tr>
              </table>
            </div>
            ...
            <div style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
                  ...
                  <td style="border-right: 1px solid black; border-bottom: 1px solid black; padding: 5px; width: 38%; font-size: 9px;"></td>
                  ...
                  <td style="border-bottom: 1px solid black; padding: 5px; width: 38%; font-size: 9px;"></td>
                </tr>
                <tr>
                  <td style="border-right: 1px solid black; border-bottom: 1px solid black; padding: 5px; font-weight: bold; font-size: 9px;">Office:</td>
                  <td style="border-right: 1px solid black; border-bottom: 1px solid black; padding: 5px; font-size: 9px;"></td>
                  ...
                  <td style="border-bottom: 1px solid black; padding: 5px;">
                    <table style="width: 100%; border-collapse: collapse;">
                      <tr>
                        ...
                        <td style="padding: 5px; font-weight: bold; font-size: 9px;"></td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <div style="padding: 8px;">
                ...
                <div style="border: 1px solid black; padding: 12px; min-height: 100px; position: relative;">
                  ...
                  <div style="position: absolute; bottom: 12px; right: 15px;">
                    <div style="font-family: 'Brush Script MT', cursive; font-size: 12px; font-style: italic; color: #003366; text-align: center; margin-bottom: 3px;"></div>
              ...
              <table style="width: 100%; border-collapse: collapse; border-top: 1px solid black; border-bottom: 1px solid black;">
                <tr>
                  ...
                  <td style="border-right: 1px solid black; padding: 2px; width: 35%;">
                    <input type="text" value="" style="width: 100%; border: none; font-size: 9px; padding: 2px;" />
                  </td>
                ...
                <tr>
                  <td style="width: 50%; padding: 4px; border-right: 1px solid black;">
                    <div style="border: 1px solid black; text-align: center; height: 50px; display: flex; flex-direction: column; justify-content: center; position: relative;">
                      <div style="font-family: 'Brush Script MT', cursive; font-size: 14px; font-style: italic; color: #003366; margin-bottom: 5px;"></div>
                  ...
                  <td style="width: 50%; padding: 4px;">
                    <div style="border: 1px solid black; text-align: center; height: 50px; display: flex; flex-direction: column; justify-content: center; padding: 2px;">
                      <div style="font-size: 10px; font-weight: bold; margin-bottom: 2px;"></div>
            ...
            <div style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;">
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                  <!-- Action rows will be dynamically loaded here -->
                  <tr>
