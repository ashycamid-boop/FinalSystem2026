      ...
      <div class="main-content">
        ...
        <div class="container-fluid p-4">
          ...
          try {
            ...
            // Initialize counts for compact status summary
            $counts = [
            ...
            while ($r = $stmtCounts->fetch(PDO::FETCH_ASSOC)) {
              ...
              $c = (int)$r['cnt'];
              if ($s === '') {
                // empty case_status: treat as under investigation by default
                ...
                // fallback: count as under investigation
                $counts['under-investigation'] += $c;
              }
            }
        ...
        if (tbody) {
          ...
          if (visibleCount === 0) {
            if (!placeholder) {
              ...
              nr.innerHTML = '<td colspan="10" class="text-center">No approved cases found.</td>';
