...
<head>
  ...
  <style>
    ...
    .layout, .main, .main-content, .container-fluid { overflow: visible !important; max-height: none !important; height: auto !important; }
              ...
              <table style="width: 100%; border-collapse: collapse; border-top: 1px solid black; border-bottom: 1px solid black;">
                <tr>
                  ...
                  <td style="border-right: 1px solid black; padding: 2px; width: 35%;">
                    ...
                    <input type="text" name="auth1_name" value="<?php echo htmlspecialchars($auth1_name); ?>" style="<?php echo $auth1_input_style; ?>" />
                  </td>
              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
                  <td style="width: 50%; padding: 4px; border-right: 1px solid black;">
                    ...
                    <div class="signature-box" data-field="auth1" style="<?php echo $auth1_sig_style; ?>">
              ...
              <table style="width: 100%; border-collapse: collapse; border-top: 1px solid black; border-bottom: 1px solid black;">
                <tr>
                  ...
                  <td style="border-right: 1px solid black; padding: 2px; width: 35%;">
                    ...
                    <input type="text" name="auth2_name" value="<?php echo htmlspecialchars($auth2_name); ?>" style="<?php echo $auth2_input_style; ?>" />
                  </td>
                  <td style="border-right: 1px solid black; padding: 4px; font-weight: bold; width: 20%; font-size: 9px;">Title/Position:</td>
                  <td style="padding: 2px; width: 30%;">
              ...
              <table style="width: 100%; border-collapse: collapse; border-bottom: 1px solid black;">
                <tr>
                  <td style="width: 50%; padding: 4px; border-right: 1px solid black;">
                    ...
                    <div class="signature-box" data-field="auth2" style="<?php echo $auth2_sig_style; ?>">
                      ...
                      <tr data-action-row="<?php echo $i; ?>">
                        <?php
                          ...
                          if ($isFirst && $approval_blocked && $missing_action) {
                            ...
                            if ($missing_action) $sig_box_style = 'border:1px solid #d9534f; height:40px; display:flex; align-items:center; justify-content:center; padding:4px; cursor:pointer; background:#fff;';
                          }
