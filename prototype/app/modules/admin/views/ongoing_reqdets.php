    ...
    <div class="main">
      ...
      <div class="main-content">
        <div class="container-fluid p-4">
          ...
          <?php
          // Use request id from query string; default to empty to avoid demo fallbacks
          ...
          <div style="max-width: 850px; margin: 0 auto; background: white; font-family: Arial, sans-serif; font-size: 11px;">
            ...
            <div style="padding: 10px; border-left: 1px solid black; border-right: 1px solid black;">
              ...
              <table style="width: 100%; margin-bottom: 10px;">
                <tr>
                  <td style="width: 50%;"><strong style="font-size: 10px;">Ticket No: <?= htmlspecialchars($request_id) ?></strong></td>
                  <td style="width: 50%; text-align: right;"><strong style="font-size: 10px;">Date (mm/dd/yyyy): <?= isset($request['date']) ? htmlspecialchars($request['date']) : '' ?></strong></td>
                </tr>
              </table>
            </div>
            ...
            <div style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
                  ...
                  <td style="border-right: 1px solid black; border-bottom: 1px solid black; padding: 5px; width: 38%; font-size: 9px;"><?= isset($request['requester_name']) ? htmlspecialchars($request['requester_name']) : '' ?></td>
                ...
                <tr>
                  ...
                  <td style="border-right: 1px solid black; padding: 5px; font-size: 9px;"><?= isset($request['phone']) ? htmlspecialchars($request['phone']) : '' ?></td>
            ...
            <div style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black;">
              ...
              <div style="padding: 8px;">
                ...
                <div style="border: 1px solid black; padding: 12px; min-height: 100px; position: relative;">
                  <div style="font-size: 9px;"><?= isset($request['description']) ? htmlspecialchars($request['description']) : '' ?></div>
                  <div style="position: absolute; bottom: 12px; right: 15px;">
                    <div style="font-family: 'Brush Script MT', cursive; font-size: 12px; font-style: italic; color: #003366; text-align: center; margin-bottom: 3px;"><?= isset($request['requester_name']) ? htmlspecialchars($request['requester_name']) : '' ?></div>
