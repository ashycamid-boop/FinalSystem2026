        ...
        <div class="container-fluid p-4">
          ...
          <div class="report-section mb-4">
            <table class="table table-bordered">
              ...
              <?php if (!empty($report['status_comment'])): ?>
              <tr>
                <td class="field-label">Status Comment:</td>
                <td colspan="5"><?= nl2br(htmlspecialchars($report['status_comment'])) ?></td>
              </tr>
              <?php endif; ?>
              <?php else: ?>
              <tr>
                  ...
                  <?php if ($report && !empty($report['evidence_files'])): ?>
                    <?php foreach ($report['evidence_files'] as $ef): ?>
                        <div class="file-item mb-2">
                          ...
                          <?php /* filesize display removed per request */ ?>
                        </div>
                      <?php endforeach; ?>
                  <?php else: ?>
            ...
            <table class="table table-bordered" style="width: 200px;">
              <tr>
                <td class="text-center">
                  <h6>Status</h6>
                  <?php if ($report): ?>
                    <span class="badge bg-<?= ($report['status'] ?? '') === 'Draft' ? 'warning' : 'success' ?> fs-6"><?= htmlspecialchars($report['status'] ?? '') ?></span>
                  <?php else: ?>
